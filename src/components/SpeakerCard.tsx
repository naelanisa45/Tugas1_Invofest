...
export const SpeakerCard: React.FC<SpeakerCardProps> = ({
    ...
    return (
        <div className="cursor-pointer flex flex-col items-center gap-4 group">
            ...
            <div className="absolute bottom-0 px-4 py-6 rounded-lg w-full h-full flex flex-col items-center gap-2 group-hover:bg-red-200 backgdrop-blur-sm transition-all duration-300"></div>
